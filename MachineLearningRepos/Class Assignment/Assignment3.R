...
prp(kyTree,main="Decision Tree for Kyphosis",sub ="Analysis using Kyphosis as Class Variable")
...
prp(kyTrainTree,main="Training Decision Tree for Kyphosis",sub ="Analysis using Kyphosis as Class Variable in Training Data Set")
...
prp(kyTrain90Tree,main="Training Decision Tree for 90 percent data
...
soldfn <- function(temp=2)
{
  ...
  prp(soldTree,main="Decision Tree for Solder",sub ="Analysis using Solder as Class Variable")
  ...
  prp(soldTrainTree,main="Training Decision Tree for Solder",sub ="Analysis using Solder as Class Variable in Training Data Set")
  ...
  prp(soldTrain90Tree,main="Training Decision Tree for 90 percent data
...
if(as.integer(value)==1)
{
  ...
  print("============== BEGIN KYPHOSIS RESULTS ====================================================")
  
  kyfn()
  
  print("============== END OF KYPHOSIS RESULTS ====================================================")
...
if(as.integer(value) ==2)
{
  ...
  print("============== BEGIN SOLDER RESULTS ====================================================")
  dev.new( width=8, height=10) #Setting Space for Decision Tree
  
  soldfn() #Calling decision tree
  print("============== END SOLDER RESULTS ====================================================")
