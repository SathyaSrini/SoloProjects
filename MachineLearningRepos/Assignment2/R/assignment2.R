...
prp(myTrainingTree,main="Decision Tree for DataSet", sub = "Assignment2 - Submission by SathyaNarayanan Srinivasan(sxs142031)")
...
prp(prunedTree,main="Pruning Tree for DataSet", sub = "Assignment2 - Submission by SathyaNarayanan Srinivasan(sxs142031)")
#Printing the summary of the model
printcp(prunedTree)
